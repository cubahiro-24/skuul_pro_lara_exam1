                    ...
                    <tr class="hover:bg-cyan-500/5 transition-colors">
                        ...
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <button class="p-2 rounded-lg bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/20 transition-colors">
                                ...
                                <button class="p-2 rounded-lg bg-green-500/10 border border-green-500/30 text-green-400 hover:bg-green-500/20 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
